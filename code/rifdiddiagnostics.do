** In this dofile we attempt RIF-DiD analysis of RTW laws
...
cap log close
log using $linreg/rifdiddiagnostics.log, replace
...
** FIXME commented for diagnostics
** drop if hispracesex ==.
...
reg lwage3 treat_st i.hisprace i.state i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc3 i.quarter unemp [aw = finalwt1] if female == 0, vce(cluster state)
	
reg lwage3 treat_st i.hisprace i.state i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc3 i.quarter unemp [aw = finalwt1] if female == 1, vce(cluster state)

reg lwage3 treat_st i.hisprace i.state i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc3 i.quarter unemp [aw = finalwt1] if female == 0 & covered == 0, vce(cluster state)
	
reg lwage3 treat_st i.hisprace i.state i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc3 i.quarter unemp [aw = finalwt1] if female == 1 & covered == 0, vce(cluster state)

reg lwage3 treat_st i.hisprace i.state i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc3 i.quarter unemp [aw = finalwt1] if female == 0 & covered == 1, vce(cluster state)
	
reg lwage3 treat_st i.hisprace i.state i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc3 i.quarter unemp [aw = finalwt1] if female == 1 & covered == 1, vce(cluster state)
...
qui tab hisprace, gen(dumhisprace)

** note collinearity from dummy variable trap ?
** with quarter fe 
putexcel set $linreg/rifdiddiagnostics_coefs, replace sheet("data")
	putexcel A1 = "name"
	putexcel B1 = "coef"
	putexcel C1 = "bse"
	putexcel D1 = "lb"
...
forvalues qt = 10(10)90{
	...
	rifreg lwage3 treat_st dumhisprace* dumstate* dumyear* dumnind* educ exper exper2 exper3 exper4 edex dumee_cl* marr partt public cmsa dumnocc3* dumquarter* unemp if female == 0 [w = finalwt1], q(`qt')
	...
	rifreg lwage3 treat_st dumhisprace* dumstate* dumyear* dumnind* educ exper exper2 exper3 exper4 edex dumee_cl* marr partt public cmsa dumnocc3* dumquarter* unemp if female == 1 [w = finalwt1], q(`qt')
	...
	rifreg lwage3 treat_st dumhisprace* dumstate* dumyear* dumnind* educ exper exper2 exper3 exper4 edex dumee_cl* marr partt public cmsa dumnocc3* dumquarter* unemp if female == 0 & covered == 0 [w = finalwt1], q(`qt')
	...
	rifreg lwage3 treat_st dumhisprace* dumstate* dumyear* dumnind* educ exper exper2 exper3 exper4 edex dumee_cl* marr partt public cmsa dumnocc3* dumquarter* unemp if female == 1 & covered == 0 [w = finalwt1], q(`qt')
	...
	rifreg lwage3 treat_st dumhisprace* dumstate* dumyear* dumnind* educ exper exper2 exper3 exper4 edex dumee_cl* marr partt public cmsa dumnocc3* dumquarter* unemp if female == 0 & covered == 1 [w = finalwt1], q(`qt')
	...
	rifreg lwage3 treat_st dumhisprace* dumstate* dumyear* dumnind* educ exper exper2 exper3 exper4 edex dumee_cl* marr partt public cmsa dumnocc3* dumquarter* unemp if female == 1 & covered == 1 [w = finalwt1], q(`qt')

** In this dofile we compare alwaysr2w to neverr2w - so treat_st = treat_s (not DiD, post treat and post cont comparison)
...
cap log close
log using $linreg/stagarnr.log, replace
...
** NOTE TREAT_ST == TREAT_S (not DiD, post treat and post cont comparison) / drop i.state - collinearity

reg covered blackrelwhite treat_st treat_stblackrelwhite i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 0, vce(cluster state)
	
reg covered blackrelwhite treat_st treat_stblackrelwhite i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 1, vce(cluster state)

reg lwage3 blackrelwhite treat_st treat_stblackrelwhite i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 0, vce(cluster state) 
	
reg lwage3 blackrelwhite treat_st treat_stblackrelwhite i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 1, vce(cluster state)

reg lwage3 blackrelwhite treat_st treat_stblackrelwhite i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 0 & covered == 0, vce(cluster state)
	
reg lwage3 blackrelwhite treat_st treat_stblackrelwhite i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 1 & covered == 0, vce(cluster state)

reg lwage3 blackrelwhite treat_st treat_stblackrelwhite i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 0 & covered == 1, vce(cluster state)
	
reg lwage3 blackrelwhite treat_st treat_stblackrelwhite i.year i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 1 & covered == 1, vce(cluster state)

...
cap log close
log using $linreg/stagdid-fe-sltt-wo-ar2w.log, replace
...
reg lwage3 blackrelwhite treat_st treat_stblackrelwhite i.state i.year i.state#c.lyear i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 0, vce(cluster state) 

** estadd local unemp_level "Yes"
** estadd local yr_dum "Yes"
** estadd local sltt "Yes"
eststo wagstagdid_mal_all_fe_sltt  
...
reg lwage3 blackrelwhite treat_st treat_stblackrelwhite i.state i.year i.state#c.lyear i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 1, vce(cluster state)

** estadd local unemp_level "Yes"
** estadd local yr_dum "Yes"
** estadd local sltt "Yes"
eststo wagstagdid_fem_all_fe_sltt
...
reg lwage3 blackrelwhite treat_st treat_stblackrelwhite i.state i.year i.state#c.lyear i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 0 & covered == 0, vce(cluster state)

** estadd local unemp_level "Yes"
** estadd local yr_dum "Yes"
** estadd local sltt "Yes"
eststo nwagstagdid_mal_all_fe_sltt 
...
reg lwage3 blackrelwhite treat_st treat_stblackrelwhite i.state i.year i.state#c.lyear i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 1 & covered == 0, vce(cluster state)

** estadd local unemp_level "Yes"
** estadd local yr_dum "Yes"
** estadd local sltt "Yes"
eststo nwagstagdid_fem_all_fe_sltt 
...
reg lwage3 blackrelwhite treat_st treat_stblackrelwhite i.state i.year i.state#c.lyear i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 0 & covered == 1, vce(cluster state)

estadd local unemp_level "Yes"
estadd local yr_dum "Yes"
estadd local sltt "Yes"
eststo uwagstagdid_mal_all_fe_sltt 
...
reg lwage3 blackrelwhite treat_st treat_stblackrelwhite i.state i.year i.state#c.lyear i.nind educ exper exper2 exper3 exper4 edex i.ee_cl marr partt  public cmsa i.nocc2 unemp i.quarter [aw = finalwt1] if female == 1 & covered == 1, vce(cluster state)

estadd local unemp_level "Yes"
estadd local yr_dum "Yes"
estadd local sltt "Yes"
eststo uwagstagdid_fem_all_fe_sltt
...
// esttab covstagdid_mal_all covstagdid_mal_all_unemp covstagdid_mal_all_sltt covstagdid_fem_all covstagdid_fem_all_unemp covstagdid_fem_all_sltt using $tabs/fin_covstagdid.tex, se title(Difference in Differences of Union Coverage on Right to Work Laws Treatment in State and Time) mgroups("Men" "Women", pattern(1 0 0 1 0 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) keep(blackrelwhite treat_st treat_stblackrelwhite) nomtitles replace label starlevels(* 0.1 ** 0.05 *** 0.01) scalars("unemp_level State Monthly Unemployment Rate" "yr_dum Year Fixed Effect" "sltt State Linear Time Trends")

esttab wagstagdid_mal_all wagstagdid_mal_all_unemp wagstagdid_mal_all_sltt wagstagdid_mal_all_fe_sltt wagstagdid_fem_all wagstagdid_fem_all_unemp wagstagdid_fem_all_sltt wagstagdid_fem_all_fe_sltt using $tabs/feslttwagstagdid1-wo-ar2w.tex, se title(Difference in Differences of Real Log Wages on Right to Work Laws Treatment in State and Time) mgroups("Men" "Women", pattern(1 0 0 0 1 0 0 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) keep(blackrelwhite treat_st treat_stblackrelwhite) nomtitles replace label starlevels(* 0.1 ** 0.05 *** 0.01) 

esttab nwagstagdid_mal_all nwagstagdid_mal_all_unemp nwagstagdid_mal_all_sltt nwagstagdid_mal_all_fe_sltt nwagstagdid_fem_all nwagstagdid_fem_all_unemp nwagstagdid_fem_all_sltt nwagstagdid_fem_all_fe_sltt using $tabs/feslttwagstagdid2-wo-ar2w.tex, se title(Difference in Differences of Real Log Wages on Right to Work Laws Treatment in State and Time) mgroups("Men" "Women", pattern(1 0 0 0 1 0 0 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) keep(blackrelwhite treat_st treat_stblackrelwhite) nomtitles replace label starlevels(* 0.1 ** 0.05 *** 0.01)

esttab uwagstagdid_mal_all uwagstagdid_mal_all_unemp uwagstagdid_mal_all_sltt uwagstagdid_mal_all_fe_sltt uwagstagdid_fem_all uwagstagdid_fem_all_unemp uwagstagdid_fem_all_sltt uwagstagdid_fem_all_fe_sltt using $tabs/feslttwagstagdid3-wo-ar2w.tex, se title(Difference in Differences of Real Log Wages on Right to Work Laws Treatment in State and Time) mgroups("Men" "Women", pattern(1 0 0 0 1 0 0 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) keep(blackrelwhite treat_st treat_stblackrelwhite) nomtitles replace label starlevels(* 0.1 ** 0.05 *** 0.01) scalars("unemp_level State Monthly Unemployment Rate" "yr_dum Year Fixed Effect" "sltt State Linear Time Trends")

panelcombine, use($tabs/feslttwagstagdid1-wo-ar2w.tex $tabs/feslttwagstagdid2-wo-ar2w.tex $tabs/feslttwagstagdid3-wo-ar2w.tex) paneltitles("All (Black and White) People" "People Not Covered by Union - Spillover Effect" "People Covered by Union - Direct Effect") columncount(3) save($tabs/fin_feslttwagstagdid-wo-ar2w.tex)

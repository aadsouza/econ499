...
\pagebreak
\appendix
\newgeometry{top=0.55in,bottom=0.55in,left=0.3in,right=0.3in}
...
\begin{table}[h!]
    \centering
    \captionof{figure}{Position of Median Person on Wage Distribution of White Person}\label{fig:med_centile_time}
    \begin{tabular}{c}
...
\pagebreak
\begin{landscape}
\small{\input{tabs/fin_feslttwagstagdid}}
...
\begin{table}[h!]
    ...
    \begin{tabular}{c}
          \includegraphics[width = 0.75\textwidth, keepaspectratio]{figures/kde1men/fin_cu_bhw_men.png} \\
          \includegraphics[width = 0.75\textwidth, keepaspectratio]{figures/kde1men/fin_cn_bhw_men.png}
    \end{tabular}
\end{table}
\footnotesize{Sample include years 1983-2019 excluding 1994 and 1995.}
